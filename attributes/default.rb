...
default[:jenkins][:plugins]["config-file-provider"] = "2.9.2"
...
default[:jenkins][:plugins]["git-client"] = "1.18.0"
default[:jenkins][:plugins]["git"] = "2.4.0"
default[:jenkins][:plugins]["github-api"] = "1.69"
default[:jenkins][:plugins]["github"] = "1.12.1"
default[:jenkins][:plugins]["greenballs"] = "1.14"
default[:jenkins][:plugins]["htmlpublisher"] = "1.5"
...
default[:jenkins][:plugins]["sauce-ondemand"] = "1.138"
