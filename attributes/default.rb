...
default[:jenkins][:plugins]["config-file-provider"] = "2.7.5"
...
default[:jenkins][:plugins]["dashboard-view"] = "2.9.4"
default[:jenkins][:plugins]["description-setter"] = "1.9"
default[:jenkins][:plugins]["email-ext"] = "2.39.3"
default[:jenkins][:plugins]["external-monitor-job"] = "1.4"
default[:jenkins][:plugins]["extra-columns"] = "1.15"
default[:jenkins][:plugins]["git-client"] = "1.16.1"
default[:jenkins][:plugins]["git"] = "2.3.5"
default[:jenkins][:plugins]["github-api"] = "1.66"
default[:jenkins][:plugins]["github"] = "1.11.2"
...
default[:jenkins][:plugins]["matrix-project"] = "1.4"
default[:jenkins][:plugins]["maven-plugin"] = "2.9"
...
default[:jenkins][:plugins]["ws-cleanup"] = "0.25"
...
default[:sonar][:plugins][:java][:version] = "3.0"
...
default[:sonar][:plugins][:jacoco][:version] = "3.0"
default[:sonar][:plugins][:jacoco][:url] = "#{node[:sonar][:repo]}/java/java-jacoco/#{node[:sonar][:plugins][:jacoco][:version]}/java-jacoco-#{node[:sonar][:plugins][:jacoco][:version]}.jar"
...
default[:sonar][:plugins][:findbugs][:version] = "3.1"
...
default[:sonar][:plugins][:pmd][:version] = "2.3"
