...
default[:jtalks][:users][:i_dev][:known_hosts][:i_dev] = ["jtalks.org","#{node[:jtalks][:hostname]}"]
default[:jtalks][:users][:i_qa][:known_hosts][:i_qa] = ["jtalks.org","#{node[:jtalks][:hostname]}"]
default[:jtalks][:users][:i_performance][:known_hosts][:i_performance] = ["jtalks.org","#{node[:jtalks][:hostname]}"]
default[:jtalks][:users][:i_preprod][:known_hosts][:i_preprod] = ["jtalks.org","#{node[:jtalks][:hostname]}"]
default[:jtalks][:users][:i_javatalks][:known_hosts][:i_javatalks] = ["jtalks.org","#{node[:jtalks][:hostname]}"]
...
default[:jtalks][:users][:i_preprod][:known_hosts][:u98642] = ["jtalks.org","#{node[:jtalks][:hostname]}"]
