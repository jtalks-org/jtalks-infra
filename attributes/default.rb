...
default[:jenkins][:plugins]["credentials"] = "1.24"
...
default[:jenkins][:plugins]["git-client"] = "1.19.2"
default[:jenkins][:plugins]["git"] = "2.4.1"
...
default[:jenkins][:plugins]["jira"] = "2.1"
default[:jenkins][:plugins]["jquery"] = "1.11.2-0"
default[:jenkins][:plugins]["junit"] = "1.10"
...
default[:sonar][:repo][:java] = "http://downloads.sonarsource.com/plugins/org/sonarsource/java"
default[:sonar][:plugins][:java][:version] = "3.4"
...
default[:sonar][:plugins][:squid][:version] = "3.4"
...
default[:sonar][:plugins][:surefire][:version] = "3.4"
...
default[:sonar][:plugins][:checkstyle][:url] = "#{node[:sonar][:repo][:other]}/java/sonar-checkstyle-plugin/#{node[:sonar][:plugins][:checkstyle][:version]}/sonar-checkstyle-plugin-#{node[:sonar][:plugins][:checkstyle][:version]}.jar"
default[:sonar][:plugins][:findbugs][:version] = "3.2"
default[:sonar][:plugins][:findbugs][:url] = "#{node[:sonar][:repo][:other]}/java/sonar-findbugs-plugin/#{node[:sonar][:plugins][:findbugs][:version]}/sonar-findbugs-plugin-#{node[:sonar][:plugins][:findbugs][:version]}.jar"
default[:sonar][:plugins][:pmd][:version] = "2.4.1"
default[:sonar][:plugins][:pmd][:url] = "#{node[:sonar][:repo][:other]}/java/sonar-pmd-plugin/#{node[:sonar][:plugins][:pmd][:version]}/sonar-pmd-plugin-#{node[:sonar][:plugins][:pmd][:version]}.jar"
