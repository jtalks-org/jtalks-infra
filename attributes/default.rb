...
default[:jenkins][:plugins]["build-pipeline-plugin"] = "1.4.9"
default[:jenkins][:plugins]["build-name-setter"] = "1.5.1"
default[:jenkins][:plugins]["cloudbees-folder"] = "5.3"
default[:jenkins][:plugins]["conditional-buildstep"] = "1.3.3"
default[:jenkins][:plugins]["copy-to-slave"] = "1.4.4"
default[:jenkins][:plugins]["config-file-provider"] = "2.10.0"
default[:jenkins][:plugins]["createjobadvanced"] = "1.8"
default[:jenkins][:plugins]["credentials"] = "1.25"
...
default[:jenkins][:plugins]["git"] = "2.4.2"
default[:jenkins][:plugins]["github-api"] = "1.72.1"
default[:jenkins][:plugins]["github"] = "1.17.1"
...
default[:jenkins][:plugins]["jira"] = "2.2"
...
default[:jenkins][:plugins]["sauce-ondemand"] = "1.149"
default[:jenkins][:plugins]["scm-api"] = "1.0"
default[:jenkins][:plugins]["sectioned-view"] = "1.20"
default[:jenkins][:plugins]["script-realm"] = "1.5"
default[:jenkins][:plugins]["script-security"] = "1.17"
...
default[:jenkins][:plugins]["workflow-aggregator"] = "1.13"
