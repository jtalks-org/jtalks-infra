...
default[:jenkins][:plugins]["htmlpublisher"] = "1.9"
...
default[:jenkins][:plugins]["parameterized-trigger"] = "2.29"
...
default[:jenkins][:plugins]["sauce-ondemand"] = "1.146"
...
default[:jenkins][:plugins]["ssh-agent"] = "1.8"
...
default[:jenkins][:plugins]["token-macro"] = "1.12"
default[:jenkins][:plugins]["translation"] = "1.12"
default[:jenkins][:plugins]["windows-slaves"] = "1.1"
default[:jenkins][:plugins]["workflow-aggregator"] = "1.11"
