...
default[:jtalks][:logs_instances_web] = ["qa","dev","preprod","performance","autotests"]
...
default[:jtalks][:dbs] = ["crowd","autotests","performance","preprod","preprod_antarcticle","dev_jcommune",
...
## plugins
default[:jenkins][:plugins]["ansicolor"] = "0.4.2"
default[:jenkins][:plugins]["ant"] = "1.2"
default[:jenkins][:plugins]["build-pipeline-plugin"] = "1.5.2"
default[:jenkins][:plugins]["build-name-setter"] = "1.5.1"
default[:jenkins][:plugins]["cloudbees-folder"] = "5.7"
default[:jenkins][:plugins]["conditional-buildstep"] = "1.3.3"
default[:jenkins][:plugins]["copy-to-slave"] = "1.4.4"
default[:jenkins][:plugins]["config-file-provider"] = "2.10.1"
default[:jenkins][:plugins]["createjobadvanced"] = "1.8"
default[:jenkins][:plugins]["credentials"] = "1.27"
default[:jenkins][:plugins]["crowd2"] = "1.8"
default[:jenkins][:plugins]["cvs"] = "2.12"
default[:jenkins][:plugins]["dashboard-view"] = "2.9.7"
default[:jenkins][:plugins]["description-setter"] = "1.10"
default[:jenkins][:plugins]["durable-task"] = "1.9"
default[:jenkins][:plugins]["email-ext"] = "2.41.3"
default[:jenkins][:plugins]["external-monitor-job"] = "1.4"
default[:jenkins][:plugins]["extra-columns"] = "1.16"
default[:jenkins][:plugins]["git-client"] = "1.19.6"
default[:jenkins][:plugins]["git"] = "2.4.4"
default[:jenkins][:plugins]["github-api"] = "1.72.1"
default[:jenkins][:plugins]["github"] = "1.18.1"
default[:jenkins][:plugins]["greenballs"] = "1.15"
default[:jenkins][:plugins]["htmlpublisher"] = "1.11"
default[:jenkins][:plugins]["extended-read-permission"] = "1.0"
default[:jenkins][:plugins]["groovy"] = "1.29"
default[:jenkins][:plugins]["javadoc"] = "1.3"
default[:jenkins][:plugins]["jira"] = "2.2.1"
default[:jenkins][:plugins]["jquery"] = "1.11.2-0"
default[:jenkins][:plugins]["junit"] = "1.11"
default[:jenkins][:plugins]["ldap"] = "1.11"
default[:jenkins][:plugins]["mailer"] = "1.16"
default[:jenkins][:plugins]["mapdb-api"] = "1.0.6.0"
default[:jenkins][:plugins]["mask-passwords"] = "2.8"
default[:jenkins][:plugins]["matrix-auth"] = "1.3.2"
default[:jenkins][:plugins]["matrix-project"] = "1.6"
default[:jenkins][:plugins]["maven-plugin"] = "2.12.1"
...
default[:jenkins][:plugins]["parameterized-trigger"] = "2.30"
default[:jenkins][:plugins]["performance"] = "1.11"
default[:jenkins][:plugins]["plain-credentials"] = "1.1"
...
default[:jenkins][:plugins]["sauce-ondemand"] = "1.150"
default[:jenkins][:plugins]["scm-api"] = "1.1"
default[:jenkins][:plugins]["sectioned-view"] = "1.20"
default[:jenkins][:plugins]["script-realm"] = "1.5"
default[:jenkins][:plugins]["script-security"] = "1.18"
default[:jenkins][:plugins]["show-build-parameters"] = "1.0"
default[:jenkins][:plugins]["ssh-agent"] = "1.10"
default[:jenkins][:plugins]["ssh-credentials"] = "1.11"
default[:jenkins][:plugins]["ssh-slaves"] = "1.10"
default[:jenkins][:plugins]["subversion"] = "2.5.7"
default[:jenkins][:plugins]["throttle-concurrents"] = "1.8.5"
default[:jenkins][:plugins]["token-macro"] = "1.12.1"
default[:jenkins][:plugins]["translation"] = "1.12"
default[:jenkins][:plugins]["windows-slaves"] = "1.1"
default[:jenkins][:plugins]["ws-cleanup"] = "0.28"

default[:jenkins][:plugins]["workflow-aggregator"] = "2.0"
default[:jenkins][:plugins]["workflow-api"] = "2.0"
default[:jenkins][:plugins]["workflow-durable-task-step"] = "2.0"
default[:jenkins][:plugins]["workflow-cps-global-lib"] = "2.0"
default[:jenkins][:plugins]["workflow-cps-global-lib"] = "2.0"
default[:jenkins][:plugins]["workflow-job"] = "2.0"
default[:jenkins][:plugins]["pipeline-build-step"] = "2.0"
default[:jenkins][:plugins]["workflow-multibranch"] = "2.0"
default[:jenkins][:plugins]["workflow-cps"] = "2.0"
default[:jenkins][:plugins]["workflow-scm-step"] = "2.0"
default[:jenkins][:plugins]["pipeline-stage-step"] = "2.0"
default[:jenkins][:plugins]["pipeline-input-step"] = "2.0"
...
default[:sonar][:source_url] = "http://sonarsource.bintray.com/Distribution/sonarqube/sonarqube-#{node[:sonar][:version]}.zip"
...
default[:sonar][:repo][:other] = "http://downloads.sonarsource.com/plugins/org/codehaus/sonar-plugins"
default[:sonar][:repo][:java] = "http://sonarsource.bintray.com/Distribution"

default[:sonar][:plugins][:java][:version] = "3.9"
default[:sonar][:plugins][:java][:url] = "#{node[:sonar][:repo][:java]}/sonar-java-plugin/sonar-java-plugin-#{node[:sonar][:plugins][:java][:version]}.jar"
default[:sonar][:plugins][:checkstyle][:version] = "2.4"
default[:sonar][:plugins][:checkstyle][:url] = "#{node[:sonar][:repo][:java]}/sonar-checkstyle-plugin/sonar-checkstyle-plugin-#{node[:sonar][:plugins][:checkstyle][:version]}.jar"
default[:sonar][:plugins][:findbugs][:version] = "3.3"
default[:sonar][:plugins][:findbugs][:url] = "#{node[:sonar][:repo][:java]}/sonar-findbugs-plugin/sonar-findbugs-plugin-#{node[:sonar][:plugins][:findbugs][:version]}.jar"
default[:sonar][:plugins][:pmd][:version] = "2.5"
default[:sonar][:plugins][:pmd][:url] = "#{node[:sonar][:repo][:java]}/sonar-pmd-plugin/sonar-pmd-plugin-#{node[:sonar][:plugins][:pmd][:version]}.jar"
default[:sonar][:plugins][:crowd][:version] = "2.0"
default[:sonar][:plugins][:crowd][:url] = "#{node[:sonar][:repo][:other]}/sonar-crowd-plugin/#{node[:sonar][:plugins][:crowd][:version]}/sonar-crowd-plugin-#{node[:sonar][:plugins][:crowd][:version]}.jar"
default[:sonar][:plugins][:cobertura][:version] = "1.6.3"
default[:sonar][:plugins][:cobertura][:url] = "#{node[:sonar][:repo][:other]}/sonar-cobertura-plugin/#{node[:sonar][:plugins][:cobertura][:version]}/sonar-cobertura-plugin-#{node[:sonar][:plugins][:cobertura][:version]}.jar"
default[:sonar][:plugins][:issues_density][:version] = "1.0"
default[:sonar][:plugins][:issues_density][:url] = "#{node[:sonar][:repo][:other]}/sonar-issues-density-plugin/#{node[:sonar][:plugins][:issues_density][:version]}/sonar-issues-density-plugin-#{node[:sonar][:plugins][:issues_density][:version]}.jar"
