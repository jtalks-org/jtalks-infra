...
default[:jenkins][:plugins]["config-file-provider"] = "2.9.3"
...
default[:jenkins][:plugins]["dashboard-view"] = "2.9.6"
...
default[:jenkins][:plugins]["git-client"] = "1.19.0"
default[:jenkins][:plugins]["git"] = "2.4.0"
default[:jenkins][:plugins]["github-api"] = "1.71"
...
default[:jenkins][:plugins]["groovy"] = "1.27"
