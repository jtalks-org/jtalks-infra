...
default[:jenkins][:plugins]["credentials"] = "1.20"
...
default[:jenkins][:plugins]["email-ext"] = "2.38.2"
...
default[:jenkins][:plugins]["git"] = "2.2.10"
...
default[:jenkins][:plugins]["matrix-auth"] = "1.1"
default[:jenkins][:plugins]["matrix-project"] = "1.3"
default[:jenkins][:plugins]["maven-plugin"] = "2.5"
default[:jenkins][:plugins]["nested-view"] = "1.14"
default[:jenkins][:plugins]["antisamy-markup-formatter"] = "1.1"
default[:jenkins][:plugins]["pam-auth"] = "1.1"
...
default[:jenkins][:plugins]["sauce-ondemand"] = "1.109"
...
default[:sonar][:jvm_opts] = "-Xmx768mf -XX:MaxPermSize=384m"
