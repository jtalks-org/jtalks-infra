...
default[:jenkins][:plugins]["git-client"] = "1.19.5"
default[:jenkins][:plugins]["git"] = "2.4.2"
default[:jenkins][:plugins]["github-api"] = "1.72"
default[:jenkins][:plugins]["github"] = "1.13.3"
default[:jenkins][:plugins]["greenballs"] = "1.15"
default[:jenkins][:plugins]["htmlpublisher"] = "1.10"
...
default[:jenkins][:plugins]["ssh-agent"] = "1.9"
