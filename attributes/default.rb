...
default[:jenkins][:plugins]["build-name-setter"] = "1.5"
...
default[:jenkins][:plugins]["jira"] = "2.0.3"
...
default[:jenkins][:plugins]["sauce-ondemand"] = "1.143"
...
default[:jenkins][:plugins]["workflow-aggregator"] = "1.10"
