...
default[:jenkins][:plugins]["build-pipeline-plugin"] = "1.4.5"
...
default[:jenkins][:plugins]["git"] = "2.3.4"
...
default[:jenkins][:plugins]["junit"] = "1.4"
...
default[:jenkins][:plugins]["maven-plugin"] = "2.8"
...
default[:jenkins][:plugins]["parameterized-trigger"] = "2.25"
...
default[:jenkins][:plugins]["sauce-ondemand"] = "1.115"
