jtalks_infra_jenkins "jenkins" do
  ...
  deployment_password node[:jenkins][:maven][:users][:deployment][:password]
  deployment_username node[:jenkins][:maven][:users][:deployment][:name]
  antarcticle_password node[:jenkins][:maven][:users][:antarcticle][:password]
  antarcticle_username node[:jenkins][:maven][:users][:antarcticle][:name]
